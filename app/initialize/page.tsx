...
export default function Loading() {
  ...
  useEffect(() => {
    if (status === 'authenticated') {
      ...
      //api call gia an einai prwth fora an einai tote router push first time 
      //call me ola ta dedomena wste na ta grapsei px kai an einai ontws prwth fora 
      // alliws pane me sto profil
  ...
  return (<div className='absolute bg-black w-screen h-screen z-30 '>
