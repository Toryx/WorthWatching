...
export default function MoviePage({ params }: { params: { genre: string } }) {
  const MoviesPage = async () => {
    const genres = await query<Movie>(`SELECT title as title,genre_id as id ,
                                      ...
                                      "https://m.media-amazon.com/images/M/MV5BMTk1MzY1MzU1MF5BMl5BanBnXkFtZTcwOTQ2NjM3MQ@@._V1_.jpg"
                                       as src FROM movie left join movie_genres on movie_genres.movie_id = movie.movie_id  where genre_id = ${params.genre}`);
    return (
      // <div>
